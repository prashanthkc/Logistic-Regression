# -*- coding: utf-8 -*-
"""
Created on Thu Apr  1 13:20:25 2021
...
#Importing Data
affairs = pd.read_csv("F:/assignment/Logistic Regression/Datasets_LR/Affairs.csv", sep = ",")
...
#Importing Data
ads = pd.read_csv("F:/assignment/Logistic Regression/Datasets_LR/advertising.csv", sep = ",")
...
# Model building 
logit_model = sm.logit('Clicked_on_Ad ~  Daily_Time_Spent_on_Site + Age + Area_Income + Daily_Internet_Usage + Male',data = ads).fit()
#summary
logit_model.summary2() # for AIC
logit_model.summary()
...
#Importing Data
election_data = pd.read_csv("F:/assignment/Logistic Regression/Datasets_LR/election_data.csv", sep = ",")
...
#Importing Data
bank_data = pd.read_csv("F:/assignment/Logistic Regression/Datasets_LR/bank_data.csv", sep = ",")
